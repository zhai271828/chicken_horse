...
export class SplashScreen {
    ...
    constructor(p, gameWidth, gameHeight, bgImage = null, menuFont = null) {
        ...
        const buttonGap = 20;
        const buttonW = 100;
        const buttonH = GameConfig.BUTTON1_H;
        const totalButtonsWidth = buttonW * 3 + buttonGap * 2;
        ...
        this.button2 = new RectButton(
            p,
            buttonsLeft + buttonW + buttonGap,
            buttonY,
            buttonW,
            buttonH,
            '联机',
        );
        this.button3 = new RectButton(
            p,
            buttonsLeft + (buttonW + buttonGap) * 2,
            buttonY,
            buttonW,
            buttonH,
            '设置',
    ...
    render(
        ...
        this.button2.defaultColour = { r: 100, g: 200, b: 255 };
        this.button2.changedColour = { r: 70, g: 170, b: 220 };
        this.button3.defaultColour = { r: 255, g: 160, b: 200 };
        this.button3.changedColour = { r: 220, g: 120, b: 175 };
        this.button1.textSize = 30;
        this.button2.textSize = 30;
        this.button3.textSize = 30;

        this.button1.drawButton(p, mx, my);
        this.button2.drawButton(p, mx, my);
        this.button3.drawButton(p, mx, my);

        this.button1.updateCursor(mx, my);
        this.button2.updateCursor(mx, my);
        this.button3.updateCursor(mx, my);
    ...
    menuActionAt(mx, my) {
        ...
        if (this.button2.isHovered(mx, my)) return 'multiplayer';
        if (this.button3.isHovered(mx, my)) return 'settings';
        return null;
    }
