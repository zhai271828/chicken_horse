...
export class PlayerScore {
    constructor(playerNo) {
        ...
        // Extended tracking for titles
        this.trapsPlaced = 0;       // traps placed this round (地图污染者)
        this.deathsInLastMinute = 0; // deaths in last 60 seconds (真不怕死)
        this.deathTimestamps = [];   // for tracking deaths in time windows
        this.reviveThenFinish = false; // consecutive revive then finish (不死鸟)
        this.finishTimes = [];       // for tracking average finish time (速通之神)
    }
